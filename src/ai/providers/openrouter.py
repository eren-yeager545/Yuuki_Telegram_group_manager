...
class OpenRouterProvider(AIProvider):
    ...
    def __init__(self, api_keys: List[str], model: str = "meta-llama/llama-3.1-8b-instruct:free"):
        ...
        **kwargs
        ...
        async with httpx.AsyncClient(timeout=timeout) as client:
            ...
            if resp.status_code == 200:
                ...
                raise ValueError("OpenRouter returned invalid choices structure")
            else:
                error_body = resp.text[:200]
                raise httpx.HTTPStatusError(
                    f"OpenRouter API Error Status {resp.status_code}: {error_body}",
